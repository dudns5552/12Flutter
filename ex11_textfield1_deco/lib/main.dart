          ...
          children: <Widget>[
            ...
            SizedBox(
              ...
              child: TextField(
                ...
                //활성화 여부 설정 
                enabled: true,
                /** 키보드의 타입으로 텍스트필드에 포커싱되면 자동으로 키보드가 올라온다. 일반적인 qwerty나 이메일, 숫자형식 등으로 변경할 수 있다.  */
                ...
                decoration: const InputDecoration(
                  ...
                  //디폴트로 제공되는 카운터를 숨김처리 한다. 주석처리 하면 박스 하단에 보여진다.  
                  // counterText: '',
                ...
                //입력값이 변할때마다 이벤트 발생됨 
                onChanged: (text) {
                  /** 입력된 텍스트의 길이를 얻어와서 변수에 할당한 후 화면을 리렌더링 한다.  */
                  setState(() {
                    _count = text.length;
                  });
                  print('$text - $_count');
            ...
            OutlinedButton(
              ...
              /** 입력값이 없는 텍스트필드의 내용을 얻어와서 변수에 할당한다. 즉 빈 텍스트를 할당하는 것이므로, 텍스트를 지우는 역할을 한다. */
              onPressed: () {
                setState(() {
