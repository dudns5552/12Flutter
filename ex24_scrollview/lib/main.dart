            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Text('Entry A', style: const TextStyle(fontSize: 30)),
                ),
                Container(
                  width: double.infinity,
                  height: 200,
                  ...
                  child: Text('Entry b', style: const TextStyle(fontSize: 30)),
                ),
                Container(
                  width: double.infinity,
                  height: 200,
                  ...
                  child: Text('Entry c', style: const TextStyle(fontSize: 30)),
                ),
                Container(
                  width: double.infinity,
                  height: 200,
                  ...
                  child: Text('Entry d', style: const TextStyle(fontSize: 30)),
                ),
                Container(
                  width: double.infinity,
                  height: 200,
